-- 임베딩 데이터 삽입
-- 텍스트 임베딩 삽입
INSERT INTO `gen-lang-client-0790720774.descent_demo.text_embeddings` (id, text, embedding)
SELECT 
  id,
  body as text,
  CASE 
...
-- 구조화 특징 벡터 삽입
INSERT INTO `gen-lang-client-0790720774.descent_demo.struct_embeddings` (id, features)
SELECT 
  id,
...
INSERT INTO `gen-lang-client-0790720774.descent_demo.combined_embeddings` (id, text_embedding, struct_embedding, combined_embedding)
SELECT 
  t.id,
  t.embedding as text_embedding,
  s.features as struct_embedding,
  ARRAY_CONCAT(t.embedding, s.features) as combined_embedding
FROM `gen-lang-client-0790720774.descent_demo.text_embeddings` t
